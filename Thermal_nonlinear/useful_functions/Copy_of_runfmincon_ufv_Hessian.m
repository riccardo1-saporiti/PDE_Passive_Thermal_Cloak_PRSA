function [xsol,fval,history,grad_norm,lambda] = Copy_of_runfmincon_uv_Hessian( cost_with_grad_param , constraint ,  param , z_0 , lb )
...
objfun = cost_with_grad_param;
    ...
    'MaxIterations', 6000 , 'FiniteDifferenceType' , 'central' , 'SubproblemAlgorithm' , 'cg' , 'HessianMultiplyFcn', @HessMultFcn );
